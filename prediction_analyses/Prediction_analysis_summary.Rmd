...
These results are based on the analyses performed using the singularity container on stampede2 during period of October 10-15.  
...
# turn r values into r-squared
task_shuffle[,binary==FALSE]=task_shuffle[,binary==FALSE]**2
survey_shuffle[,binary==FALSE]=survey_shuffle[,binary==FALSE]**2
baseline_shuffle[,binary==FALSE]=baseline_shuffle[,binary==FALSE]**2
task[,binary==FALSE]=task[,binary==FALSE]**2
survey[,binary==FALSE]=survey[,binary==FALSE]**2
baseline[,binary==FALSE]=baseline[,binary==FALSE]**2
...
for (v in rownames(results_df)) {
  results_df[v,'task_p']=1-perc(results_df['taskmean'][rownames(results_df)==v,],task_shuffle[,v])
  results_df[v,'survey_p']=1-perc(results_df['surveymean'][rownames(results_df)==v,],survey_shuffle[,v])
