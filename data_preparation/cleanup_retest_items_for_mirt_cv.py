...
retestdir=get_info('retest_directory')
#dataset=get_info('dataset')
if usefull:
    print('using full dataset')
    derived_dir=os.path.join(retestdir,'Data/Derived_Data/%s'%dataset.replace('Discovery','Combined').replace('Validation','Combined'))
else:
