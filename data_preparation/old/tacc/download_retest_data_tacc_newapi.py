...
if len(sys.argv) < 4:
    sys.exit("Usage: download_retest_data_tacc.py 'Self Regulation Retest Battery' 'http://www.expfactory.org/new_api/results/62/' 'http://www.expfactory.org/new_api/results/62/?page=2' '1' ")
...
#load Data
token = get_info('expfactory_token', infile='/corral-repl/utexas/poldracklab/users/zenkavi/Self_Regulation_Ontology/Self_Regulation_Retest_Settings_Tacc_NewApi.txt')
try:
    data_dir=get_info('data_directory', infile='/corral-repl/utexas/poldracklab/users/zenkavi/Self_Regulation_Ontology/Self_Regulation_Retest_Settings_Tacc_NewApi.txt')
except Exception:
    data_dir=path.join(get_info('base_directory', infile='/corral-repl/utexas/poldracklab/users/zenkavi/Self_Regulation_Ontology/Self_Regulation_Retest_Settings_Tacc_NewApi.txt'),'Data')
