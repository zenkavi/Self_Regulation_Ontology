...
var second_instructions_block = {
	...
	pages: [
		...
		'<div class = centerbox><p class = block-text>After you end instructions we will start practice.</p><p class = block-text>After practice we will show you the instructions again, but please make sure you understand them as well as you can now.</p></div>'
	],
	allow_keys: false,
	show_clickable_nav: true,
	timing_post_trial: 1000
