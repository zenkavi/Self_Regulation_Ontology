...
var start_practice_block = {
  ...
  text: '<div class = centerbox><p class = center-block-text>We will now begin. </p><p class = center-block-text>Press <strong>enter</strong> to continue.</p></div>',
  cont_key: [13]
};
