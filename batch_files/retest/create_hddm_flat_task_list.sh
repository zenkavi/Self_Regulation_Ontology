...
do
    ...
    do
    	...
    	do
        	...
        	echo "python calculate_hddm_flat.py ${exp_id} ${sub_id} /oak/stanford/groups/russpold/users/zenkavi/Self_Regulation_Ontology/Data/Retest_01-23-2018/Individual_Measures/ ${subset}" >> flat_tasks_list.sh
        	elif [[ "$subset" == t1 ]]; then
        	echo "python calculate_hddm_flat.py ${exp_id} ${sub_id} /oak/stanford/groups/russpold/users/zenkavi/Self_Regulation_Ontology/Data/Retest_01-23-2018/t1_data/Individual_Measures/ ${subset}" >> flat_tasks_list.sh
        	fi
        done	
    done
done